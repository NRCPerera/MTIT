...
const swaggerOptions = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description: 'Microservice for managing buyers in the Smart Agriculture Supply Chain System.',
      contact: {
    ...
    servers: [
      {
        ...
        description: 'Buyer Service (Direct)',
      },
      {
...
app.use('/api-docs', swaggerUi.serve, swaggerUi.setup(swaggerDocs, {
  ...
  customSiteTitle: 'Buyer Service - API Docs',
}));
