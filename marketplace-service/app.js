...
const swaggerOptions = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description: 'Microservice for managing crop product listings and orders in the Smart Agriculture Supply Chain System.',
      contact: {
...
app.use('/api-docs', swaggerUi.serve, swaggerUi.setup(swaggerDocs, {
  ...
  customSiteTitle: 'Marketplace Service - API Docs',
}));
